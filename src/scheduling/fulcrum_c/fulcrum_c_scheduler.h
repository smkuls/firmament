...
#ifndef FIRMAMENT_SCHEDULING_FULCRUM_SCHEDULER_H
#define FIRMAMENT_SCHEDULING_FULCRUM_SCHEDULER_H
...
class FulcrumScheduler : public EventDrivenScheduler {
 public:
  FulcrumScheduler(shared_ptr<JobMap_t> job_map,
  ...
  virtual ostream& ToString(ostream* stream) const {
    return *stream << "<FulcrumScheduler>";
  }

 private:
  // Unit tests
  FRIEND_TEST(FulcrumSchedulerTest, LazyGraphReductionTest);
...
#endif  // FIRMAMENT_SCHEDULING_FULCRUM_SCHEDULER_H
